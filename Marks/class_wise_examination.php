        ...
        <form action="" method="post">
          <table id="tbl">
            <tr>
              ...
              <td>
              <input type="text" name="Exam" size="30" required>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <tbody>
                <tr>
                  ...
                  if (isset($_POST['add'])) {
                    ...
                    $max = $_POST['Max_Marks'];
                    if(empty($class)){
                      echo "<script>alert('Class Not Selected');location.replace('class_wise_examination.php')</script>";
                    }
                    elseif(empty($exam)){
                      echo "<script>alert('Exam Not Selected');location.replace('class_wise_examination.php')</script>";
                    }
                    else{
