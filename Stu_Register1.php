...
<div class="wrapper">
    ...
    <div class="container-fluid" id="main">
      ...
      <div class="details-form">
        ...
        <form autocomplete="off" method="post" action="stu_add_data.php">
          ...
          <table width="100%">
            <tr>
              ...
              <td>Admission No.</td>
              <td>
                <input type="text" name="Adm_No" size="20" required>
                <span style="color: red;">*</span>
              </td>
            </tr>
            <tr>
              <td>Class</td>
              <td>
                <select class="form-control" name="Stu_Class" id="" required>
              ...
              <td>Section</td>
              <td>
                <select class="form-control" name="Stu_Section" id="" required>
            ...
            <tr>
              ...
              <td>SurName</td>
              <td>
                <input type="text" name="sur_name" size="30" required>
                <span style="color: red;">*</span>
              </td>
            </tr>
            <tr>
              <td>Father's Name</td>
              <td>
                <input type="text" name="Father_Name" size="30" required>
                <span style="color: red;">*</span>
              </td>
              <td>Mother's Name</td>
              <td>
                <input type="text" name="Mother_Name" size="30" required>
                <span style="color: red;">*</span>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="radio" name="Gender" value="Girl" style="margin-left: 50px;">Girl
                <span style="color: red;">*</span>
              </td>
            </tr>
            <tr>
              <td>Mobile Number</td>
              <td>
                <input type="text" name="Mobile" size="30" minlength="10" maxlength="10" required>
                <span style="color: red;">*</span>
              </td>
              <td>Student Image</td>
              <td>
            ...
            <tr>
              <td>Aadhar Number</td>
              <td>
                <input type="text" name="Aadhar" minlength="12" maxlength="12" size="30" required>
                <span style="color: red;">*</span>
              </td>
            </tr>
          </table>
          ...
          <table width="100%">
            <tr>
              <td>Religion</td>
              <td colspan="1">
                <input type="radio" name="Religion" value="Indian-Hindu" required>Indian-Hindu
                <input type="radio" name="Religion" value="Indian-Islam" style="margin-left: 50px;">Indian-Islam
                <input type="radio" name="Religion" value="Indian-Christian" style="margin-left: 50px;">Indian-Christian
                <span style="color: red;">*</span>
              </td>
            </tr>
            <tr>
              <td>Caste</td>
              <td>
                <input type="text" name="Caste" size="25" required>
                <span style="color: red;">*</span>
              </td>
              <td>Category</td>
              <td>
...
-->
          ...
          <table width="100%">
            ...
            <tr>
              <td>Van Route</td>
            <td>
              <input type="text" name="Van_Route">
            </td>
            </tr>
            <tr>
              <td>Referred By</td>
