...
session_start();
if (!$_SESSION['Id_No']) {
  echo "<script>alert('Login ID Not Available');
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item">
                <a class="nav-link" href="my_information.php" style="text-decoration: none;color:black;">My Information</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container-fluid" id="main">
      <div class="container-fluid" id="header">
        <div class="row">
          ...
          <img src="Images/<?php echo $_SESSION['Stu_Id_No'] . ".jpg" ?>" alt="Img Not Available" id="user-img" width="100px" height="100px" style="border-radius: 50%;">
          <div class="profile col-md-3">
            <a href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <h4><?php echo $_SESSION['Stu_Id_No'] . "(Student)" ?><img src="Images/arrow.png" width="20px" id="arrow"></h4>
            </a>
