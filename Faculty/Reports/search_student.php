            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio1">Student Name</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="search_by" id="sur_name" value="Sur_Name">
                        <label class="form-check-label" for="inlineRadio2">Surname</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="search_by" id="father_name" value="Father_Name">
                        <label class="form-check-label" for="inlineRadio3">Father's Name</label>
                    </div>
                </div>
            </div>
